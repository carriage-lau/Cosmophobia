...
{
    // TODO: add a pause screen, pause all actors. pause screen has UI elements including resume/settings/leave
}

void ACosmophobiaCharacter::ResumeGame()
{
    // TODO: opposite of pause game -- get rid of pause screen and resume all actors. see above.
}
